/**
 * @file clickDrag.js
 * Exports a click drag component. This is taken from the aframe-click-drag
 * component. I (Patrick) modified the mouse position calculation mechanism,
 * and PR-ed the changes against the canonical package (referenced PR in @link).
 * You might ask, didn't you just install this module from your branch/commit
 * instead of pulling this component and your changes in directly? Good question
 * mate. Due to the way the aframe-click-drag-component is published, it
 * requires a pre-publish compilation step. I did not want to publish my own
 * version of this module to NPM. So until the referenced PR is merged into the
 * canonical module, this will have to do. Also, this file is ignored as far
 * as eslint is concerned because the author has a different set of rules.
 *
 * {@link https://github.com/jesstelford/aframe-click-drag-component/pull/22}
 *
 */
